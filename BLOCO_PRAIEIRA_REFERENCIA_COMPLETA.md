# 🦀 BLOCO PRAIEIRA - DOCUMENTO DE REFERÊNCIA COMPLETA

> **Documento oficial com todas as informações do Bloco Praieira para desenvolvimento do site**
> 
...
- **Fundadores**: 
  ...
  - Vinícius Guichabeira (irmão) - In Memoriam 🕊️
...
3. **Samba**
   - Ritmo clássico do carnaval brasileiro
...
### 🎤 HARMONIA (Seção Melódica)

#### 1. Vozes
- Coro principal
- Vocais de apoio
- Responsáveis pela melodia e letras

#### 2. Violão
- Base harmônica
- Acompanhamento melódico
- Suporte para as vozes

#### 3. Baixo
- Base harmônica grave
- Groove e sustentação rítmica
- Conexão entre harmonia e percussão

---

### 🥁 PERCUSSÃO (Seção Rítmica)

#### 1. Caixa
- **Função**: Percussão de base e marcação do ritmo
- **Características**: Som agudo e cortante
- **Importância**: Marcação principal do tempo

#### 2. Surdo
- **Função**: Percussão grave que dá a base rítmica
- **Características**: Som grave e profundo
- **Importância**: Pulsação e sustentação do ritmo

#### 3. Xequerê (também grafado Xequerê ou Chequerê)
- **Função**: Instrumento de percussão afro-brasileiro
- **Características**: Cabaça envolvida por uma rede de contas
- **Som**: Chocalhar característico
- **Origem**: Cultura afro-brasileira

#### 4. Ganzá
- **Função**: Percussão de chocalho para marcação
- **Características**: Chocalho cilíndrico metálico
- **Som**: Contínuo e metálico
- **Importância**: Textura rítmica constante

#### 5. Agogô
- **Função**: Instrumento de percussão metálico
- **Características**: Dois sinos de metal de diferentes alturas
- **Som**: Metálico e penetrante
- **Origem**: Instrumento africano tradicional

#### 6. Repinique (também grafado Repique)
- **Função**: Percussão de chamada e variações rítmicas
- **Características**: Som agudo e versátil
- **Importância**: Chamadas, viradas e improvisações
- **Técnica**: Tocado com uma baqueta e uma mão

#### 7. Tamborim
- **Função**: Percussão aguda com detalhes rítmicos
- **Características**: Pequeno tambor de aro
- **Som**: Agudo e brilhante
- **Técnica**: Tocado com baqueta fina
...
### Tamanho do Grupo
- **Total aproximado**: 20 integrantes
- **Estrutura**: Divididos entre harmonia e percussão

### Fundadores (Liderança)
1. **Charles Guichabeira**
   - Cofundador
   - Um dos irmãos criadores do bloco

2. **Vinícius Guichabeira**
   - Cofundador
   - Um dos irmãos criadores do bloco

### Distribuição por Seção
- **Harmonia**: Vozes, violão, baixo
...
### Área de Atuação
- Santo André (principal)
- ABC Paulista (região metropolitana)
- Grande São Paulo (eventos especiais)
...
#### 1. Carnaval de Rua
- Desfiles oficiais de carnaval
- Blocos de rua
- Apresentações durante o período carnavalesco
- Carnaval de Santo André e região

#### 2. Bares e Estabelecimentos
- Apresentações regulares em bares
- Shows em casas de cultura
- Eventos em espaços culturais
- Bar "A Praieira" (local de origem)
...
### Calendário Típico
- **Carnaval**: Período principal (fevereiro/março)
- **Ano todo**: Apresentações em bares e eventos
- **Datas especiais**: Eventos culturais da região
...
### Missão
Promover a cultura do carnaval de rua e dos ritmos afro-brasileiros no ABC Paulista, democratizando o acesso à música e à festa, fortalecendo os laços comunitários através da arte e da celebração.

### Valores

#### 1. Cultura Popular
- Valorização das tradições brasileiras
...
- Promover a festa e a celebração
- Criar momentos memoráveis

#### 4. Comunidade
- Fortalecer os laços locais
- Integração do ABC Paulista
- Pertencimento coletivo

#### 5. Respeito
- Às tradições musicais
...
- **Cultura Litorânea**: Referência a "Praieira"
- **Resistência**: Força e persistência
- **Raízes Brasileiras**: Conexão com a cultura popular
- **Alegria**: Festividade e celebração
- **Identidade**: Marca reconhecível e única

### Cores (Tema Visual do Site)
- **Base**: Tema escuro (dark theme)
- **Neon Verde**: #39FF14 (neon-green)
- **Neon Rosa/Magenta**: #FF10F0 (neon-pink)
- **Neon Azul/Cyan**: #00FFFF (neon-blue)
- **Fundo**: Preto e tons escuros de roxo (#1a0033)
- **Efeito**: Glassmorphism (vidro fosco)

### Estilo Visual
- **Tema**: Dark/Neon
- **Estética**: Moderna, vibrante, urbana
- **Inspiração**: Cyberpunk brasileiro, carnaval moderno
- **Efeitos**: Brilho neon, sombras coloridas, transparências
...
### Objetivo
- Apoiar as atividades do bloco
- Manutenção de instrumentos
- Custear apresentações
...
## 📋 INFORMAÇÕES TÉCNICAS PARA O SITE

### Funcionalidades Necessárias

#### 1. Página Inicial (Hero)
- Logo/símbolo do caranguejo
- Nome "Bloco Praieira"
- Slogan/descrição
- História resumida (fundadores, ano, local)
- Ritmos que tocam
...
#### 3. Seção de Membros
- Accordion/expansível por instrumento
- Lista de fundadores
- Harmonia (3 instrumentos)
- Percussão (7 instrumentos)
- Possibilidade de cadastro futuro via admin
...
- **Hospedagem**: Vercel (frontend) + Supabase/Railway (database)
- **PIX**: Integração com APIs de pagamento brasileiras
...
### Tipografia
- **Fonte principal**: Inter, sans-serif (moderna e clean)
- **Títulos**: Bold, grandes, com gradient
- **Corpo**: Regular, legível
- **Efeitos**: Neon glow em títulos importantes

### Componentes
- **Glassmorphism**: Backdrop blur, bordas sutis
- **Cards**: Transparentes com borda
- **Buttons**: Gradientes neon, hover com glow
...
### Contexto Cultural
- **Maracatu**: Manifestação cultural de Pernambuco, com forte presença africana
...
- Integração PIX essencial para doações brasileiras
- SEO importante para busca local (Santo André, ABC)
...
*Este documento serve como referência completa para o desenvolvimento do site oficial do Bloco Praieira. Todas as informações aqui contidas foram fornecidas pelos fundadores e devem ser consideradas oficiais.*

🦀 **BLOCO PRAIEIRA** - Santo André, ABC Paulista, SP
